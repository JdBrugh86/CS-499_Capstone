...
// Add comment explaining what this code is for
...
using namespace std;                // Remove namespace

struct Course {                     // Add comment to describe Course struct and where it is used
    string courseId;
    string courseTitle;
    vector<string> preReqs;
};

struct Node {                       // Add comment describing Node struct
    Course course;
    Node* left;
    Node* right;
...
class BinarySearchTree {            // Add comment to describe BST class, add remove/delete method, add update method
    ...
    private:
        ...
        void postOrder(Node* node); // Not called; remove
        void preOrder(Node* node);  // Not called; remove
        Node* removeNode(Node* node, string courseId); // Implement remove/delete method
    
    public:
        BinarySearchTree();
        virtual ~BinarySearchTree();
        void InOrder();
        void PostOrder();           // Not called; remove
        void PreOrder();            // Not called; remove
...
void BinarySearchTree::deleteBST(Node* node) {          // Add comment describing method, remove unnecessary comments
...
/**
 * Add a course to some node (recursive)    // Add comment noting what id will be used for placement
 *
 ...
 */
void loadCSV(string csvPath, BinarySearchTree* bst) {       // Can be broken out into its own module
...
/**
 * The one and only main() method       // Remove. Unecessary
 */
int main() {
